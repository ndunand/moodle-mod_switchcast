...
$string['switch_admin_host_desc'] = 'Address where the SWITCHCAST administration interface is to be found.';
...
$string['logging_enabled_desc'] =
        'Log all XML API calls and responses.<br />The log file is found in {$a}/mod/switchcast/switchcast_api.log';
...
$string['pageno'] = 'Page #';
$string['pagination'] =
        'Displaying clips <span class="switchcast-cliprange-from"></span> to <span class="switchcast-cliprange-to"></span> of <span class="switchcast-cliprange-of"></span>.';
...
$string['event:clip_viewed_desc'] =
        'User with id \'{$a->userid}\' viewed a clip in switchcast activity module id \'{$a->contextinstanceid}\'.';
$string['event:member_invited'] = 'Member invited';
$string['event:member_invited_desc'] =
        'User with id \'{$a->userid}\' invited user with id \'{$a->relateduserid}\' to a clip in switchcast activity module id \'{$a->contextinstanceid}\'.';
$string['event:member_revoked'] = 'Member revoked';
$string['event:member_revoked_desc'] =
        'User with id \'{$a->userid}\' revoked invitation of user with id \'{$a->relateduserid}\' to a clip in switchcast activity module id \'{$a->contextinstanceid}\'.';
$string['event:clip_uploaded'] = 'Clip uploaded';
$string['event:clip_uploaded_desc'] =
        'User with id \'{$a->userid}\' uploaded a clip in switchcast activity module id \'{$a->contextinstanceid}\'.';
$string['event:clip_deleted'] = 'Clip deleted';
$string['event:clip_deleted_desc'] =
        'User with id \'{$a->userid}\' deleted a clip in switchcast activity module id \'{$a->contextinstanceid}\'.';
$string['event:clip_editdetails'] = 'Clip metadata updated';
$string['event:clip_editdetails_desc'] =
        'User with id \'{$a->userid}\' updated metadata from a clip in switchcast activity module id \'{$a->contextinstanceid}\'.';
