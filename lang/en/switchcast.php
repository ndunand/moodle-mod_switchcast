...
$string['switchcast:downloadclip'] = 'Able to download clips';
...
$string['template_id_help'] = 'SwitchCast template to use for the encoding of the clips. This defines which video formats are avaible and/or other features. Refer to your institution\'s instructions. <strong>This can not be modified afterwards.</strong>';
...
$string['event:clip_viewed_desc'] = 'User with id \'{$a->userid}\' viewed a clip in switchcast activity module id \'{$a->contextinstanceid}\'.';
$string['event:member_invited'] = 'Member invited';
$string['event:member_invited_desc'] = 'User with id \'{$a->userid}\' invited user with id \'{$a->relateduserid}\' to a clip in switchcast activity module id \'{$a->contextinstanceid}\'.';
$string['event:member_revoked'] = 'Member revoked';
$string['event:member_revoked_desc'] = 'User with id \'{$a->userid}\' revoked invitation of user with id \'{$a->relateduserid}\' to a clip in switchcast activity module id \'{$a->contextinstanceid}\'.';
$string['event:clip_uploaded'] = 'Clip uploaded';
$string['event:clip_uploaded_desc'] = 'User with id \'{$a->userid}\' uploaded a clip in switchcast activity module id \'{$a->contextinstanceid}\'.';
$string['event:clip_deleted'] = 'Clip deleted';
$string['event:clip_deleted_desc'] = 'User with id \'{$a->userid}\' deleted a clip in switchcast activity module id \'{$a->contextinstanceid}\'.';
$string['event:clip_editdetails'] = 'Clip metadata updated';
$string['event:clip_editdetails_desc'] = 'User with id \'{$a->userid}\' updated metadata from a clip in switchcast activity module id \'{$a->contextinstanceid}\'.';
$string['upload_clip_info'] = 'Please ensure that your file is of one of the following formats: <strong>{$a}</strong>.<br />If it is not the case, please follow the instructions provided in the following help button prior to uploading your video.';
