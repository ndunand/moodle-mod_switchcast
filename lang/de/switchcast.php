...
$string['logging_enabled_desc'] =
        'Loggen aller XML API-Calls und Antworten.<br />Die Log-Datei liegt unter {$a}/mod/switchcast/switchcast_api.log';
...
$string['pageno'] = 'Seite #';
$string['pagination'] =
        'Angezeigte Videoclips: <span class="switchcast-cliprange-from"></span> bis <span class="switchcast-cliprange-to"></span> von <span class="switchcast-cliprange-of"></span>.';
