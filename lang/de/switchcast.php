...
$string['channeltype'] = 'Typ des Kanals';
$string['channelprod'] = 'Produktiver Kanal';
$string['channeltest'] = 'Test-Kanal';
...
$string['full'] = '(Voll)';
$string['switchcastclose'] = 'Bis';
$string['switchcastname'] = 'SWITCHcast-Name';
$string['switchcastopen'] = 'Öffnen';
$string['switchcastoptions'] = 'SWITCHcast-Optionen';
...
$string['modulename_help'] = 'Das SWITCHcast-Modul erlaubt Managern und Teachern das Anlegen und Managen eines SWITCHcast-Kanals direkt aus dem Moodle-Kurs.';
$string['modulenameplural'] = 'SWITCHcast-Kanäle';
$string['mustchooseone'] = 'Vor dem Speichern müssen Sie zuerst eine Auswahl wählen. Die Änderungen wurden nicht gespeichert.';
...
$string['uid_field_desc'] = 'Feld im Nutzerprofil, welches die AAI Unique ID enthält. Form der Eingabe: &lt;fieldname&gt; ODER &lt;table::fieldid&gt;.';
...
$string['castkey_file_desc'] = 'Das SWITCHcast Key File, bereitgestellt durch SWITCHcast, um die API-Calls zu signieren.';
...
$string['enabled_institutions_desc'] = 'Komma-getrennte Liste der freigegebenen Institutionen auf diesem Moodle-Server.';
...
$string['allow_test_channels'] = 'Test-Kanäle erlauben';
$string['allow_test_channels_desc'] = 'Markieren Sie diese Option, falls Sie das Erstellen von Testkanälen erlauben möchten.';
$string['allow_prod_channels'] = 'Produktive Kanäle erlauben';
$string['allow_prod_channels_desc'] = 'Markieren Sie diese Option, falls Sie das Erstellen von produktiven Kanälen erlauben möchten.';
$string['misconfiguration'] = 'Das Plugin wurde falsch eingerichtet. Bitte kontaktieren Sie Ihren Moodle-Administrator.';
$string['channeltypeforbidden'] = 'Erstellen von {$a} Kanälen verboten, bitte kontaktieren Sie Ihren Moodle-Administrator.';
$string['logging_enabled'] = 'Logs einschalten';
$string['logging_enabled_desc'] = 'Loggen aller XML API-Calls und Antworten.<br />Die Log-Datei liegt unter {$a}/mod/switchcast/switchcast_api.log';
$string['display_select_columns'] = 'Nur benutzte Spalten anzeigen';
$string['display_select_columns_desc'] = 'In der Videoclip-Liste nur die benutzten Spalten wie Besitzer oder Aktionen anzeigen. Dies hat einen Einfluss auf die Ladegeschwindigkeit, weil die Liste aller Videoclips bei jeder Anzeige neu geladen werden muss.';
...
$string['disciplin'] = 'Fachrichtung';
$string['contenthours'] = 'Geschätze Anzahl Stunden Videomaterial';
$string['lifetime'] = 'Gewünschte Lebensdauer des SWITCHcast-Kanals';
...
$string['template_id_help'] = 'SWITCHcast-Vorlage ("Template"), welche zur Kodierung der Videoclips verwendet wird. Die Vorlage definiert unter anderem die nach der Kodierung zur Verfügung stehenden Videoformate. Beachten Sie dazu die Instruktionen Ihrer Institution. <strong>Diese Einstellung kann nachher nicht mehr geändert werden.</strong>';
...
$string['switchcast:use'] = 'Zeige Inhalt des SWITCHcast-Kanals';
$string['switchcast:isproducer'] = 'Als Produzent des SWITCHcast-Kanals registrieren (mit Zugriff auf alle Videoclips)';
$string['switchcast:addinstance'] = 'Kann eine neue SWITCHcast-Aktivität hinzufügen';
$string['switchcast:seeallclips'] = 'Kann alle Videoclips im Kurs anschauen.';
$string['switchcast:uploadclip'] = 'Kann einen Videoclip via Moodle hinzufügen';
...
$string['user_homeorgnotenabled'] = 'Um eine SWICHcast-Aktivität zu erstellen, muss Ihre HomeOrganization ({$a}) in den generellen Moodle-Einstellungen freigeschaltet sein. Bitte kontaktieren Sie Ihren Moodle-Administrator.';
...
$string['owner_no_switch_account'] = 'Es ist nicht möglich, &laquo;{$a}&raquo; als Besitzer dieses Videoclips einzutragen, weil dieser Nutzer keinen SWITCHaai-Account besitzt.';
$string['nomoreusers'] = 'Es stehen keine Nutzer mehr zum Hinzufügen zur Verfügung.';
$string['nocontenthours'] = 'Der Mindestwert der geschätzen Anzahl Stunden Videomaterial beträgt 1.';
...
$string['channelhasotherextauth'] = 'Dieser Kanal wurde bereits mit einer anderen externen Authorität verbunden: <em>{$a}</em>.';
$string['novisiblegroups'] = 'Diese Gruppeneinstellung steht für diese Aktivität nicht zur Verfügung.';
$string['nogroups_withoutivt'] = 'Getrennte Gruppen sind nur möglich, wenn die Einstellung &laquo;Individueller Zugang pro Videoclip&raquo; weiter oben aktiviert ist.';
$string['itemsperpage'] = 'Videoclips pro Seite';
$string['pageno'] = 'Seite #';
$string['pagination'] = 'Angezeigte Videoclips: <span class="switchcast-cliprange-from"></span> bis <span class="switchcast-cliprange-to"></span> von <span class="switchcast-cliprange-of"></span>.';
...
$string['notavailable'] = 'Dieser Aktivitätstyp wird zur Zeit getestet und steht noch nicht für produktive Zwecke zur Verfügung.';
$string['xml_cache_time'] = 'XML-Cache Gültigkeitsdauer';
$string['xml_cache_time_desc'] = 'Wie viele Sekunden soll die XML-Antwort des SWITCHcast-Servers im Cache behalten werden? 0 bedeutet kein Caching.';
$string['removeowner'] = 'Besitzer entfernen';
$string['channel_not_found'] = 'Der verlinkte Kanal existiert nicht (mehr?).';
$string['channeldoesnotbelong'] = 'Der verlinkte Kanal gehört zu einer anderen Organisation ({$a}), weswegen Sie ihn nicht modifizieren können. Nur ein Teacher von {$a} kann den Kanal modifizieren.';
$string['switch_api_down'] = 'Der SWITCHcast-Server antwortet nicht.';
$string['xml_fail'] = 'Fehler bei der Kommunikation mit dem SWITCHcast-Server.';
$string['badorganization'] = 'Die Organisation dieses Kanals ist nicht korrekt konfiguriert.';
$string['curl_proxy'] = 'Curl-Proxy';
$string['curl_proxy_desc'] = 'Falls Curl einen Proxy benutzen muss, tragen Sie ihn in der Form <em>proxyhostname:port</em> ein';
...
$string['allow_userupload_desc'] = 'Upload von Videoclips durch NutzerInnen direkt aus der Moodle-Aktivität in den SWITCHcast-Kanal. Die entsprechende Option innerhalb der spezifischen Aktivätät muss ebenfalls aktiviert werden.';
$string['userupload_maxfilesize'] = 'Maximale Dateigrösse pro Video';
$string['userupload_maxfilesize_desc'] = 'Maximale Grösse pro Video, die ein Nutzer pro Upload hochladen kann. Grössere Dateien bis 2 GB laden Sie bitte direkt im SWITCHcast-Kanal hoch.';
$string['userupload_error'] = 'Während dem Hochladen der Datei ist ein unerwarteter Fehler aufgetreten. Bitte versuchen Sie es nochmals.';
...
$string['moreinfo_url_desc'] = 'Beim Hinzufügen/Modifizifieren einer SWITCHcast-Aktivität wird dieser Link angezeigt, sofern dieses Feld ausgefüllt ist.';
...
$string['uploadfile_extensions_desc'] = 'Von SWITCHcast akzeptierte Dateitypen zum Hochladen. Ändern Sie diese Einstellungen, wenn sich die von SWITCHcast akzeptierten Dateitypen ändern.';
$string['fileis_notextensionallowed'] = 'Dateityp nicht erlaubt: {$a->yours}. Akzeptierte Dateitypen sind: {$a->allowed}';
$string['event:clip_viewed'] = 'Videoclip angeschaut';
$string['event:clip_viewed_desc'] = 'NutzerIn mit der ID \'{$a->userid}\' hat einen Videclip in der SWITCHcast-Aktivität (Modul-ID) \'{$a->contextinstanceid}\' angeschaut.';
$string['event:member_invited'] = 'Mitglied eingeladen';
$string['event:member_invited_desc'] = 'NutzerIn mit der ID \'{$a->userid}\' hat NutzerIn mit der ID \'{$a->relateduserid}\' die Erlaubnis zum Anschauen eines Videoclips in der SWITCHcast-Aktivität mit der Modul-ID \'{$a->contextinstanceid}\' gegeben.';
$string['event:member_revoked'] = 'Mitglied entfernt';
$string['event:member_revoked_desc'] = 'NutzerIn mit der ID \'{$a->userid}\' hat NutzerIn mit der ID \'{$a->relateduserid}\' die Erlaubnis zum Anschauen eines Videoclips in der SWITCHcast-Aktivität mit der Modul-ID \'{$a->contextinstanceid}\' entzogen.';
$string['event:clip_uploaded'] = 'Videoclip hochgeladen';
$string['event:clip_uploaded_desc'] = 'Der Nutzer mit der ID \'{$a->userid}\' hat einen Videoclip in der SWITCHcast-Aktivität mit der Modul-ID \'{$a->contextinstanceid}\' hochgeladen.';
$string['event:clip_deleted'] = 'Videoclip gelöscht';
$string['event:clip_deleted_desc'] = 'Der Nutzer mit der ID \'{$a->userid}\' hat einen Videoclip in der SWITCHcast-Aktivität mit der Modul-ID \'{$a->contextinstanceid}\' gelöscht.';
$string['event:clip_editdetails'] = 'Metadaten des Videoclips wurden aktualisiert';
$string['event:clip_editdetails_desc'] = 'Der Nutzer mit der ID \'{$a->userid}\' hat die Metadaten eines Videoclips in der SWITCHcast-Aktivität mit der Modul-ID \'{$a->contextinstanceid}\' aktualisiert.';
$string['upload_clip_info'] = 'Bitte stellen Sie sicher, dass die Videodatei eines der folgenden Formate aufweist: <strong>{$a}</strong>.<br />Wenn dies nicht der Fall ist, folgen Sie bitte den Instruktionen des folgenden Hilfe-Buttons, bevor Sie den Videoclip hochladen.';
