...
$string['modulename_help'] = 'Le module SWITCHcast permet aux enseignants de gérer un canal de vidéos SWITCHcast directement à partir d\'un espace Moodle.';
...
$string['template_id_help'] = 'Template SwitchCast à utiliser pour l\'encodage des vidéos. Ceci définit quels formats vidéo snt disponibles ainsi que d\'autres options éventuelles. Veuillez vous référer aux instructions fournies par votre institution. <strong>Ce réglage ne peut plus être modifié ensuite.</strong>';
