 ...
 */
class mod_switchcast_upload_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('header', 'mod_switchcast_upload_form_hdr',
                get_string('scast_upload_form_hdr', 'switchcast'));
        ...
        $mform->addElement('text', 'cliptitle', get_string('video_title', 'switchcast'), ['size' => 50]);
        $mform->setType('cliptitle', PARAM_RAW_TRIMMED);
        $mform->addRule('cliptitle', get_string('required'), 'required', null, 'client');

        $mform->addElement('text', 'clipsubtitle', get_string('video_subtitle', 'switchcast'), ['size' => 50]);
        ...
        $mform->addElement('text', 'cliplocation', get_string('video_location', 'switchcast'), ['size' => 50]);
