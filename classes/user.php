...
class mod_switchcast_user {
    ...
    public function __construct($aaiUniqueId = '', $moodleUserId = 0) {
        ...
        $this->switch_api = mod_switchcast_series::getValueForKey('switch_api_host');
    ...
    public static function getExtIdFromMoodleUserId($userid = 0) {
        ...
        $uid_field = mod_switchcast_series::getValueForKey('uid_field');
    ...
    public function doCreate() {
        ...
        //				'email' => $USER->email,
        //				'organization_domain' => mod_switchcast_obj::getOrganizationByEmail($this->getExternalAccount())
        //			)
        //		);
        //
        //		$url = $this->switch_api;
        //		$url .= '/users.xml';
        //
        //		$scastNewUserObj = mod_switchcast_oldapi::sendRequest($url, 'POST', $data);
        //
    ...
    public function doRead() {
        ...
        $simplexmlobj = mod_switchcast_oldapi::sendRequest($url, 'GET');
    ...
    public function getChannels() {
        ...
        // new implementation:
        $url = '/series/';
        $results = mod_switchcast_apicall::sendRequest($url, 'GET');

        $filtered_result = [];
        foreach ($results as $result) {
            $ch_acls = mod_switchcast_apicall::sendRequest('/series/' . $result->identifier . '/acl', 'GET', null, false, true, null, true, false);
