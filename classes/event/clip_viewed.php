...
class clip_viewed extends \core\event\base {
    ...
    public function get_description() {
        ...
        return get_string('event:clip_viewed_desc', 'switchcast', $a);
    }
    ...
    public static function get_name() {
        return get_string('event:clip_viewed', 'switchcast');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'switchcast', 'clip viewed', $logurl, $this->objectid, $this->contextinstanceid);
    }
