...
class clip_deleted extends \core\event\base {
    ...
    public function get_description() {
        ...
        return get_string('event:clip_deleted_desc', 'switchcast', $a);
    }
    ...
    public static function get_name() {
        return get_string('event:clip_deleted', 'switchcast');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'switchcast', 'clip deleted', $logurl, $this->objectid, $this->contextinstanceid);
    }
