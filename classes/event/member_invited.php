...
class member_invited extends \core\event\base {
    ...
    public function get_description() {
        ...
        return get_string('event:member_invited_desc', 'switchcast', $a);
    }
    ...
    public static function get_name() {
        return get_string('event:member_invited', 'switchcast');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'switchcast', 'member invited', $logurl, $this->objectid, $this->contextinstanceid);
    }
