...
class xoctMainGUI extends xoctGUI {
    ...
    public function executeCommand() {
        ...
        $this->tabs->addTab(self::TAB_SETTINGS, $this->pl->txt('tab_' . self::TAB_SETTINGS),
                $this->ctrl->getLinkTarget(new xoctConfGUI()));
        $this->tabs->addTab(self::TAB_SYSTEM_ACCOUNTS, $this->pl->txt('tab_' . self::TAB_SYSTEM_ACCOUNTS),
                $this->ctrl->getLinkTarget(new xoctSystemAccountGUI()));
        $this->tabs->addTab(self::TAB_PUBLICATION_USAGE, $this->pl->txt('tab_' . self::TAB_PUBLICATION_USAGE),
