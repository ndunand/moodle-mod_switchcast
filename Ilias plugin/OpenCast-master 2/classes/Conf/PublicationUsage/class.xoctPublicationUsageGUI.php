...
class xoctPublicationUsageGUI extends xoctGUI {
    ...
    protected function selectPublicationId() {
        ...
        $sel = new ilSelectInputGUI($this->txt(xoctPublicationUsageFormGUI::F_PUBLICATION_ID),
                xoctPublicationUsageFormGUI::F_PUBLICATION_ID);
        $options = [];
    ...
    protected function edit() {
        $xoctPublicationUsageFormGUI =
                new xoctPublicationUsageFormGUI($this, xoctPublicationUsage::find($_GET[self::IDENTIFIER]));
        $xoctPublicationUsageFormGUI->fillForm();
        $this->tpl->setContent($xoctPublicationUsageFormGUI->getHTML());
    }
