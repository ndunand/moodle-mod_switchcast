...
class xoctPublicationUsageTableGUI extends ilTable2GUI {
    ...
    public function  __construct(xoctPublicationUsageGUI $a_parent_obj, $a_parent_cmd) {
        ...
        $this->setRowTemplate('tpl.publication_usage.html',
    ...
    protected function addActionMenu(xoctPublicationUsage $xoctPublicationUsage) {
        ...
        $this->ctrl->setParameter($this->parent_obj, xoctPublicationUsageGUI::IDENTIFIER,
                $xoctPublicationUsage->getUsageId());
        $current_selection_list->addItem($this->parent_obj->txt(xoctPublicationUsageGUI::CMD_EDIT),
                xoctPublicationUsageGUI::CMD_EDIT,
                $this->ctrl->getLinkTarget($this->parent_obj, xoctPublicationUsageGUI::CMD_EDIT));
        $current_selection_list->addItem($this->parent_obj->txt(xoctPublicationUsageGUI::CMD_DELETE),
