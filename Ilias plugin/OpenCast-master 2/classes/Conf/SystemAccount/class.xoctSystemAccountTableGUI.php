...
class xoctSystemAccountTableGUI extends ilTable2GUI {
    ...
    public function  __construct(xoctSystemAccountGUI $a_parent_obj, $a_parent_cmd) {
        ...
        $this->setRowTemplate('tpl.system_accounts.html',
    ...
    protected function addActionMenu(xoctSystemAccount $xoctSystemAccount) {
        ...
        $current_selection_list->addItem($this->parent_obj->txt(xoctSystemAccountGUI::CMD_EDIT),
                xoctSystemAccountGUI::CMD_EDIT,
                $this->ctrl->getLinkTarget($this->parent_obj, xoctSystemAccountGUI::CMD_EDIT));
        $current_selection_list->addItem($this->parent_obj->txt(xoctSystemAccountGUI::CMD_DELETE),
                xoctSystemAccountGUI::CMD_DELETE,
                $this->ctrl->getLinkTarget($this->parent_obj, xoctSystemAccountGUI::CMD_CONFIRM));
