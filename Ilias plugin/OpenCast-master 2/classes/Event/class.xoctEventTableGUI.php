...
class xoctEventTableGUI extends ilTable2GUI {
    ...
    public function  __construct(xoctEventGUI $a_parent_obj, $a_parent_cmd, xoctOpenCast $xoctOpenCast) {
        ...
        $this->setRowTemplate('tpl.events.html',
    ...
    public function fillRow($a_set) {
        ...
        $this->tpl->setVariable('RECORDING_STATION',
                $xoctEvent->getMetadata()->getField('recording_station')->getValue());
    ...
    protected function addActionMenu(xoctEvent $xoctEvent) {
        ...
        $current_selection_list->addItem($this->pl->txt('event_view'), 'event_view',
                $this->ctrl->getLinkTarget($this->parent_obj, xoctEventGUI::CMD_VIEW));
    ...
    protected function parseData() {
        $filter = ['series' => $this->xoctOpenCast->getSeriesIdentifier()];
        $filter = [];
