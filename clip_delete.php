...
if (    $confirm === 1
    ...
    redirect(new moodle_url('/mod/switchcast/view.php?id='.$id));
...
echo $OUTPUT->confirm(get_string('delete_clip_confirm', 'switchcast'), $button, new moodle_url('/mod/switchcast/view.php?id='.$id));
echo $OUTPUT->footer();
